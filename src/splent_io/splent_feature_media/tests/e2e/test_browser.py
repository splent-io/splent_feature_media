"""
End-to-end tests for splent_feature_media.
...
Run with:  splent feature:test splent_feature_media --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_media")
    assert "splent_feature_media" in browser.page_source.lower()
